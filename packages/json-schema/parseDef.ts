import { ZodFirstPartyTypeKind, ZodTypeDef } from "@/packages/mod";
...
const selectParser = (
  ...
  switch (typeName) {
    ...
    case ZodFirstPartyTypeKind.ZodSymbol:
      return undefined;
    case ZodFirstPartyTypeKind.ZodInterpreter:
      return selectParser(def.schema._def, def.schema._def.typeName, refs);
    default:
