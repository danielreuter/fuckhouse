...
// import { ext, ext2 } from "./extensions/computer-helpers";
// import { MethodAny } from "./extensions/method";
...
// export type def<T extends ZodTypeAny> = T["_def"]; // +
// export type { TypeOf as infer };

// // export type ZodSetter<
// //   T extends ZodTypeAny,
// // > = (output: T["_output"]) => (...args: any[]) => void;
// export type ZodSetter<T extends ZodTypeAny> = (
//   mutation: (thisOutput: T["_output"]) => void,
// ) => void;

// export type AnyZodSetter = ZodSetter<ZodTypeAny>;
...
//     this._path = path;
//     this._key = key;
//     // this.set = (setThis: (thisOutput: any)=>void) => {
//     //   parent.set((parentOutput)=>setThis(parentOutput.key))
//     // }
//     this.set = (setThis: (thisOutput: any) => void) => {
//       parent.set((parentOutput) => setThis(parentOutput.key));
//     };
...
//     };
//   };
//   return { errorMap: customMap, description, isComputer, isMutator };
// }
...
//   Input = Output,
//   isComputer extends boolean = false,
...
//         parent: input.parent,
//         set: () => () => {},
//         log: false, // means don't have ctx prior
//       }
//     );
//   }
...
//     // this.creates = this.creates.bind(this);
//     // this.fn = this.fn.bind(this);
//     // this.mtn = this.mtn.bind(this);
//     // this.function = this.function.bind(this);
//     // this.mutation = this.mutation.bind(this);

//     this.isComputer = this._def.isComputer ?? false;
//     this.isMutator = this._def.isMutator ?? false;
//   }
...
//     Mapping extends (arg: Output) => Creates["_input"],
//     // Alias extends Creates["_def"]["identifier"] extends undefined
//     //   ? never
//     //   : Creates["_def"]["identifier"],
//     Alias extends string,
//     NewOut extends isComputer extends true
//       ? objectUtil.flatten<
//           Output extends { [k: string]: any }
//             ? Omit<Output, "create"> & {
//                 create: Output["create"] & {
//                   [K in Alias]: () => ReturnType<Mapping>;
//                 };
//               }
//             : never
//         >
...
//     alias: Alias,
//     mapping: Mapping,
//   ): ext.newComputer<isComputer, this, NewOut, Input, Output, Def> {
//     let transform: (
//       arg: Output,
//       ctx: RefinementCtx,
//     ) => NewOut | Promise<NewOut>;

//     // console.error(alias, this.isComputer);

//     if (this.isComputer) {
//       transform = ((arg: any, ctx: RefinementCtx) => {
//         // const fn = ctx.log
//         // ? () => {
//         //  console.log("Calling ", alias);
//         //  console.log("  args: ", arg)
//         //  const result = mapping(arg);
...
//     return new ZodEffects({
//       ...processCreateParams({ ...this._def, isComputer: true }),
//       isComputer: true,
//       schema: this,
//       typeName: ZodFirstPartyTypeKind.ZodEffects,
//       effect: { type: "transform", transform },
...
//   // fn<
//   //   M extends MethodAny,
//   //   C extends (contents: Output) => M["_signature"],
//   //   NewOut extends isComputer extends true
//   //     ? objectUtil.flatten<Output & { [k in M["_def"]["name"]]: ReturnType<C> }>
//   //     : objectUtil.flatten<
//   //         { _: Output } & { [k in M["_def"]["name"]]: ReturnType<C> }
//   //       >,
//   // >(
//   //   method: M,
//   //   constructor: C,
...
//   //   ) => NewOut | Promise<NewOut>;
//   //   if (this.isComputer) {
//   //     transform = ((compiled: Output, ctx: RefinementCtx) => {
//   //       // const newMethod = constructor(compiled);
//   //       // const fn = ctx.log
//   //       //   ? (...args: any[]) => {
//   //       //       console.log("Calling fn: ", method._def.name);
...
//   //         return {
//   //           ...compiled,
//   //           [method._def.name]: function (...args: any[]) {
//   //             // Access the current state of `compiled` every time the function is called
//   //             const currentCompiled = this; // `this` should refer to the current state of the object
//   //             const newMethod = constructor(currentCompiled);
...
//   //         return {
//   //           _: compiled,
//   //           [method._def.name]: function (...args: any[]): any {
//   //             // Access the current state of `compiled` every time the function is called
//   //             const currentCompiled = this; // `this` should refer to the current state of the object
//   //             const newMethod = constructor(currentCompiled as any);
...
//   //   M extends MethodAny,
//   //   C extends (
//   //     contents: Output & { set: (fn: (store: Store) => void) => void },
//   //   ) => M["_signature"],
//   //   NewOut extends isComputer extends true
//   //     ? objectUtil.flatten<
//   //         Output & { set: (fn: (store: Store) => void) => void } & {
//   //           [k in M["_def"]["name"]]: ReturnType<C>;
//   //         }
//   //       >
//   //     : objectUtil.flatten<
//   //         { _: Output } & { set: (fn: (store: Store) => void) => void } & {
//   //           [k in M["_def"]["name"]]: ReturnType<C>;
//   //         }
//   //       >,
//   // >(
...
//   //   if (this.isComputer) {
//   //     transform = ((
//   //       compiled: Output & { set: (fn: (store: Store) => void) => void },
//   //       ctx: RefinementCtx,
//   //     ) => {
//   //       const set = ctx.set;
//   //       let newMethod: any
//   //       if (this.isMutator) {
//   //         newMethod = constructor(compiled);
//   //       } else {
//   //         newMethod = constructor({ ...compiled, set });
//   //       }
...
//   //     ) => {
//   //       const set = ctx.set;
//   //       const newMethod = constructor({ ...compiled, set});
...
//   //   return new ZodEffects({
//   //     ...processCreateParams({ ...this._def, isComputer: true }), // undo this...
//   //     isComputer: true,
//   //     schema: this,
//   //     typeName: ZodFirstPartyTypeKind.ZodEffects,
//   //     effect: { type: "transform", transform },
...
//   // interpreter<Alias extends string>(
//   //   alias?: Alias,
//   // ): ZodInterpreter<Alias, this, {}, {}> {
...
//   //     constructors: () => ({}),
//   //     creators: () => ({}),
//   //     typeName: ZodFirstPartyTypeKind.ZodInterpreter,
//   //   });
//   // }

//   // fn<
//   //   wasComputer extends isComputer,
//   //   isMutator extends false,
//   //   M extends MethodAny,
//   //   ComputerInput extends ext.constructorInput<wasComputer, isMutator, Output>,
//   //   C extends (input: ComputerInput) => M["_signature"],
//   // >(
//   //   method: M,
//   //   constructor: C,
//   //   // ): ext.computer<wasComputer, isMutator, this, Input, Output, Def, M, C>  {
//   // ): ext2.computer<
//   //   wasComputer,
//   //   this,
//   //   Input,
...
//   //   Def,
//   //   ComputerInput,
//   //   ComputerInput & { [k in M["_def"]["name"]]: ReturnType<M["_signature"]> }
//   // > {
//   //   const isMutator = false;
//   //   const wasMutator = this.isMutator;
//   //   const isNewMutator = isMutator && !wasMutator;
//   //   const shouldBeMutator = this.isMutator || isMutator;
//   //   const isComputer = this.isComputer;

//   //   const transform = (compiled: Output, ctx: RefinementCtx) => {
//   //     const set = isMutator ? ctx.set : undefined;

//   //     const rest = shouldBeMutator
//   //       ? {
//   //           _isMutator: true,
//   //           set,
//   //         }
...
//   //       ...rest,
//   //       [method._def.name]: function (...args: any[]): any {
//   //         const currentCompiled = this;
//   //         console.log("is computer", isComputer);
//   //         console.log("is mutator ", isMutator);
//   //         console.log("got here, ", currentCompiled);
//   //         console.log("Calling fn: ", method._def.name);
//   //         const newMethod = constructor(currentCompiled as any);
...
//   export type Constructor<InnerOutput, F extends Functions> = (
//     input: InnerOutput,
//     other: { set: (fn: (store: Store) => void) => void },
//   ) => F;
//   export interface InterpreterDef<
//     Alias extends string,
//     T extends ZodTypeAny,
...
//   Alias extends string,
//   Inner extends ZodTypeAny,
//   F extends test.Functions,
//   Output extends test.OutputShape = test.interpreterOutput<Inner, F>,
//   Input = Inner["_input"],
// > extends ZodType<
//   Output,
//   test.InterpreterDef<Alias, Inner, test.Constructor<Inner["_output"], F>>,
//   Input
// > {
//   innerType() {
...
//   constructor(
//     def: test.InterpreterDef<
//       Alias,
//       Inner,
//       test.Constructor<Inner["_output"], F>
//     >,
//   ) {
//     super(def);
//     this.from = this.from.bind(this);
...
//     data: Input,
//     params?: Partial<ParseParams>,
//     // params?: Partial<ParseParams> // has an "errorMap"
//   ): Output {
//     const ctx: ParseContext = {
//       common: {
//         issues: [],
...
//       log: ctx.log,
//     });
//     const output = handleResult(ctx, result);
...
//               const newMethod = constructor({ ...this, set } as any);
//               if (ctx.log) {
...
//         value: Object.keys(creators).reduce((acc, alias) => {
...
//             },
//           };
//           console.log("logging new acc", newAcc);
//           return newAcc;
//         }, innerWithConstructedMethods as any),
//       };
//     } else {
//       return result;
//     }
...
// export type AnyZodObject = ZodObject<any, any, any, any>;
...
//   Object extends AnyZodObject = ZodObject<
//     { [key in Discriminator]: ZodTypeAny } & ZodRawShape,
//     UnknownKeysParam,
//     ZodTypeAny
//   >,
// > = Object | ZodInterpreter<any, Object, any>;
...
//   Input = input<T>,
//   isComputer extends boolean = false, // +
// > extends ZodType<Output, ZodEffectsDef<T>, Input, isComputer> {
//   innerType() {
//     return this._def.schema;
//   }
...
//   | ZodBranded<any, any>
//   | ZodPipeline<any, any>
//   | ZodInterpreter<any, any, any, any>;
