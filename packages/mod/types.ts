import { Setter, Store } from "@/lib/store";
...
> {
  ...
  interpret<F extends Functions>(
    constructor: Constructor<Output, F>,
  ): ZodInterpreter<this, F> {
...
type Constructor<InnerOutput, F extends Functions> = (other: {
  _: InnerOutput;
  set: Setter;
}) => F & {
  _: InnerOutput;
};
interface InterpreterDef<Alias extends string | undefined, T extends ZodTypeAny>
  extends ZodTypeDef {
  alias?: Alias;
  schema: T;
...
export class ZodInterpreter<
  ...
  Output extends OutputShape = interpreterOutput<Inner, F>,
  Input = Inner["_input"],
> extends ZodType<Output, InterpreterDef<Alias, Inner>, Input> {
  innerType() {
    return this._def.schema;
  }

  constructor(def: InterpreterDef<Alias, Inner>) {
    super(def);
    this.from = this.from.bind(this);
  }
  ...
  _parse(input: ParseInput): ParseReturnType<this["_output"]> {
    ...
    if (isValid(result)) {
      ...
      //     _isComputer: true,
      //     get: function() {
      //       console.log("getter", this._);
      //       return this._;
      //     },
      //     // init: function() {
      //     //   Object.assign(this, constructor({ get: this.get, set }));
      //     // }
      //   },
      // } as any;
      // const get = () => {
      //   return finished.value.get();
      // }
      // finished.value.init = function() {
      //   Object.assign(this, constructor({ get, set }));
      // }
      // finished.value.init();
      // return finished;
      return {
  ...
  static create<Inner extends ZodTypeAny, F extends Functions>(
    constructor: Constructor<Inner["_output"], F>,
  ) {
    return new ZodInterpreter({
      schema: this as any,
      constructor,
...
export type ZodDiscriminatedUnionOption<
  ...
  Object extends AnyZodObject = ZodObject<
    ...
    ZodTypeAny
  >,
> = Object | ZodInterpreter<Object, any>;
