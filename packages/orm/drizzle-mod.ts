...
> = TMode extends "insert"
  ? MapInsertColumnToMod<TColumn, TType>
  : MapSelectColumnToMod<TColumn, TType>;
...
> = TNoOptional extends true ? TType : MapColumnToMod<TColumn, TType, TMode>;

type GetModType<TColumn extends Column> =
  TColumn["_"]["dataType"] extends infer TDataType
    ? TDataType extends "custom"
      ? z.ZodAny
      : TDataType extends "json"
        ? z.ZodType<Json, any, unknown> // +
